...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow-sm': '0 0 15px -3px rgba(20, 184, 166, 0.3)', // Teal glow
        'glow': '0 0 25px -5px rgba(20, 184, 166, 0.4)',
        'glow-lg': '0 0 40px -8px rgba(20, 184, 166, 0.5)',
        'glow-accent': '0 0 25px -5px rgba(14, 165, 233, 0.4)', // Sky glow
      ...
      keyframes: {
        ...
        'pulse-glow': {
          ...
          '50%': { boxShadow: '0 0 30px -3px rgba(20, 184, 166, 0.6)' },
        },
      },
    },
  },
